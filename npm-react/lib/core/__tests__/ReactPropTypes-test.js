...
describe('Component Type', function() {
  ...
  it('should support components', function()  {
    typeCheck(Props.component, React.DOM.div(null ));
  ...
  it('should not support multiple components or scalar values', function()  {
    var list = [[React.DOM.div(null ), React.DOM.div(null )], 123, 'foo', false];
    list.forEach(function(value)  {return typeCheck(Props.component, value);});
  ...
  it('should be able to define a single child as children', function()  {
    var instance =
      Component(null, 
        React.DOM.div(null )
      );
  ...
  it('should warn when passing more than one child', function()  {
    var instance =
      Component(null, 
        React.DOM.div(null ),
        React.DOM.div(null )
  ...
  it('should warn when passing no children and isRequired is set', function()  {
...
describe('Union Types', function() {
  ...
  describe('React Component Types', function() {
    ...
    it('should not warn for valid values', function() {
      // DOM component
      typeCheck(Props.renderable, React.DOM.div(null ));
      expect(console.warn.mock.calls.length).toBe(0);
      // Custom component
      typeCheck(Props.renderable, MyComponent(null ));
      expect(console.warn.mock.calls.length).toBe(0);
      // String
      ...
      typeCheck(Props.renderable, [
        ...
        'Some string',
        React.DOM.div(null ),
        ['Another string', [456], React.DOM.span(null ), MyComponent(null )],
        MyComponent(null )
      ]);
      expect(console.warn.mock.calls.length).toBe(0);
      ...
      typeCheck(Props.renderable, {
        k0: 123,
        k1: 'Some string',
        k2: React.DOM.div(null ),
        k3: {
          k30: MyComponent(null ),
          k31: {k310: React.DOM.a(null )},
          k32: 'Another string'
        }
      });
      expect(console.warn.mock.calls.length).toBe(0);
