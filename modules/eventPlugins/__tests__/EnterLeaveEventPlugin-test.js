...
describe('EnterLeaveEventPlugin', function() {
  ...
  it('should set relatedTarget properly in iframe', function() {
    ...
    var component = React.renderComponent(React.DOM.div(null ), iframeDocument.body);
...
require("../../mock-modules").register("eventPlugins/__tests__/EnterLeaveEventPlugin-test", module);
